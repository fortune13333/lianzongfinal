...
const operatorFull: User = {
  ...
  username: 'op_full',
  role: 'operator',
  extra_permissions: 'device:create,device:update,device:delete,rollback:execute,user:manage,template:manage,policy:manage,system:reset,system:settings,startup:write',
};
